...
import 'package:bloc_login/features/screens/customer_module/ui/history_detaiosl.dart';
...
class CustomerPaymentHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CustomerListBloc>(
      create: (context) => CustomerListBloc()..add(FetchCustomerListEvent()),
...
class _CustomerScreenViewState extends State<CustomerScreenView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<CustomerListBloc, CustomerListStates>(
        builder: (context, state) {
          if (state is LoadingCustomerListState) {
            return const Center(
