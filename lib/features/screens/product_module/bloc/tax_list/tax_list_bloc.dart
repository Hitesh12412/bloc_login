import 'dart:convert';
import 'package:bloc_login/features/screens/product_module/bloc/tax_list/tax_list_event.dart';
import 'package:bloc_login/features/screens/product_module/bloc/tax_list/tax_list_state.dart';
  ...
  Future<void> _fetchTax(
    ...
    try {
      final response = await http.post(
        Uri.parse('https://shiserp.com/demo/api/getTaxList'),
        headers: const {
