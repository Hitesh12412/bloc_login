...
class VendorPaymentHistory extends StatelessWidget {
  const VendorPaymentHistory({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<VendorsListBloc>(
      create: (context) => VendorsListBloc()..add(FetchVendorsListEvent()),
        ...
        builder: (context, state) {
          if (state is LoadingVendorsListState) {
            ...
            return SingleChildScrollView(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            vendor.totalOutstandingPayment,
                                            style: const TextStyle(
                                              fontSize: 18,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.red,
              ...
              state is InternalServerErrorVendorsListState) {
            final errorMsg = state is FailureVendorsListState
                ? state.error
                : (state as InternalServerErrorVendorsListState).error;
