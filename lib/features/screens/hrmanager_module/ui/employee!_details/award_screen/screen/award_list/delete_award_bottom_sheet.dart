...
class DeleteAwardBottomSheet extends StatelessWidget {
  final AwardData Award;
  final VoidCallback onDeleteConfirmed;

  const DeleteAwardBottomSheet({
    super.key,
    required this.Award,
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Text(
                'Are you sure you want to delete this Award ? All associated data will be permanently removed from the system.',
