import 'package:bloc_login/features/screens/hrmanager_module/ui/employee!_details/education_screen/bloc/education_list_bloc/education_list_bloc.dart';
...
import 'package:bloc_login/features/screens/hrmanager_module/ui/employee!_details/education_screen/screen/education_list_screen/delete_education_bottom_sheet.dart';
...
class _EducationListScreenState extends State<EducationListScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: EducationListScreenWidget(
...
class EducationListScreenWidget extends StatefulWidget {
  final String employeeId;

  const EducationListScreenWidget({
    required this.employeeId,
    super.key,
  });

  @override
  State<EducationListScreenWidget> createState() => _EducationListScreenWidgetState();
}

class _EducationListScreenWidgetState extends State<EducationListScreenWidget> {
  ...
  void initState() {
    BlocProvider.of<EducationBloc>(context).add(
      FetchEducationEvent(employeeId: widget.employeeId),
    );
    super.initState();
  }
        ...
        children: [
          BlocBuilder<EducationBloc, EducationStates>(
            builder: (context, state) {
                                    ...
                                    itemBuilder: (_) => [
                                      ...
                                      PopupMenuItem<String>(
                                        onTap: () => showModalBottomSheet(
                                          ...
                                          builder: (context) {
                                            return DeleteEducationBottomSheet(
                                              Education: Education,
                                              onDeleteConfirmed: () {
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                        'Deleted Education: ${Education.school_collage_name}'),
                                                  ),
                                                );
                                              },
                                            );
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(Education.year_of_joining),
                                      ],
                                    ),
                                  ),
                                  const Spacer(),
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(
                                              Education.documentUpload.split('/').last,
              ...
              } else if (state is FailureEducationState) {
                return Center(child: Text('Error: ${state.error}'));
              } else if (state is InternalServerErrorEducationState) {
                return Center(child: Text(state.error));
              } else if (state is ServerErrorEducationState) {
                return Center(child: Text(state.error));
              }
              return Container();
            },
