...
class DeleteAgreementBottomSheet extends StatelessWidget {
  final AgreementData agreement;
  final VoidCallback onDeleteConfirmed;

  const DeleteAgreementBottomSheet({
    super.key,
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Text(
                'Are you sure you want to delete this agreement ? All associated data will be permanently removed from the system.',
