...
class DeleteExperienceBottomSheet extends StatelessWidget {
  final ExperienceData Experience;
  final VoidCallback onDeleteConfirmed;

  const DeleteExperienceBottomSheet({
    super.key,
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Text(
                'Are you sure you want to delete this Experience ? All associated data will be permanently removed from the system.',
