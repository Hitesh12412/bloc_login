...
class DeleteInsuranceBottomSheet extends StatelessWidget {
  final InsuranceData Insurance;
  final VoidCallback onDeleteConfirmed;

  const DeleteInsuranceBottomSheet({
    super.key,
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Text(
                'Are you sure you want to delete this Insurance ? All associated data will be permanently removed from the system.',
