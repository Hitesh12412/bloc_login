...
class InsuranceRepository {
  static const String _baseUrl = 'https://shiserp.com/demo/api/getInsuranceList';

  Future<InsuranceListModel> fetchInsurances({
    ...
    if (response.statusCode == 200) {
      ...
      return InsuranceListModel.fromJsonMap(jsonBody);
    } else {
